...
document.querySelector('#app').innerHTML = `   <div id="main">
    ...
    <div class="data">
        ...
        <div id="dis" class="disclaimer">
         ...
         <footer><a href="https://dsc.gg/upzare">Powered By Upzare <img src="https://media.discordapp.net/attachments/972957443753652246/1275310309485051955/0x0-removebg-preview.png?ex=66c56cc7&is=66c41b47&hm=a1e38977d36c13c5d4f2f2a43aed6b63ca68b6fcfa25898181a9e5fb932f0d7a&=&format=webp&quality=lossless" height="50px" width="50px" alt=""></a></footer>
         </div>
    </div>
